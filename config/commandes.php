...
function ajouterUser($nom, $pseudo, $email, $motdepasse)
{
  if(require("connexion.php"))
  {
    $req = $access->prepare("INSERT INTO client (nom, pseudo, email, motdepasse) VALUES (?, ?, ?, ?)");

    $req->execute(array($nom, $pseudo, $email, $motdepasse));
...
function getClient($email, $password){
  ...
  if(require("connexion.php")){
    ...
    $req = $access->prepare("SELECT * FROM client WHERE email=?");
